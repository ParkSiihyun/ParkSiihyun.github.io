...
- 중심 주제: **Understanding Business Cycles**
- 먼저 잡을 축: business cycle phases, credit cycle, sector activity, economic indicators
- 본문은 원본 필기 흐름을 유지하면서 정의, 비교, 공식, 예제를 읽기 좋게 정리한다.

## Reading Map

1. Business cycle과 credit cycle
2. Resource use와 sector activity
3. Typical business cycle characteristics
...
| Phase | 의미 |
|-------|------|
| Trough | 경기 저점, GDP growth가 negative에서 positive로 전환 |
| Expansion / Recovery | 경기 확장, real GDP 증가 |
| Peak | 경기 고점, GDP growth가 positive에서 negative로 전환 |
| Contraction / Recession | 경기 수축, real GDP 감소 |

## 2. Credit Cycle

**Credit cycle**: interest rates와 credit availability의 cyclical fluctuations.

| Phase | 필기 흐름 |
|-------|-----------|
| Credit expansion | credit이 늘고, bubble이 생길 수 있으며, interest rate는 낮아지는 경향 |
| Credit contraction | credit이 줄고, deleveraging이 나타나며, interest rate 압력이 커질 수 있음 |
